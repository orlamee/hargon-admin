        ...
        >
          <SwiperSlide>
            <div className="report-card">
              ...
              <h6 className="mt-3 text-black">₦ 0.00</h6>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="report-card">
                          ...
                          <div className="details-card pb-0">
                            ...
                            <div className="bg-white p-4">
                              ...
                              <div className="row">
                                ...
                                <div className="col-sm-3 mb-3">
                                  <h5>Work status</h5>
                                  <h6><span className="approved">Employed</span></h6>
                                </div>
                                <div className="col-sm-3 mb-3">
                                  <h5>Gross salary</h5>
                                  <h6>20,000,000</h6>
