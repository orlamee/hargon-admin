        ...
        <div className="col-sm-12 px-0">
          <div className="pending-loan">
            <div className="d-flex flex-row">
              <h5 className="me-3"><a href="/merchant-inventory"><i className="bi bi-chevron-left me-2" style={{color: "#228B22"}}></i></a>Inventory Details</h5>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="col-sm-6 mb-3">
            ...
            <Form className="mt-4">
              <Form.Group className="mb-3" >
                ...
                <Form.Control type="text" defaultValue="Samsung s20" />
              </Form.Group>
              <Form.Group className="mb-3" >
              ...
              <Row>
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" defaultValue="J345"/>
                  </Form.Group>
                ...
                <Col>
                  <Form.Group className="mb-3">
                    <Form.Label>Product Description</Form.Label>
                    <Form.Control type="text" defaultValue="Electronics"/>
                  </Form.Group>
                </Col>
              </Row>
              <Row>
              ...
              <Row>
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" defaultValue="Samsung"/>
                  </Form.Group>
                ...
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" defaultValue="Brand New"/>
                  </Form.Group>
                </Col>
              </Row>
              <Form.Group className="mb-3">
              ...
              <Row>
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control type="number" defaultValue="234" />
                  </Form.Group>
