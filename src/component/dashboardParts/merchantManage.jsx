    ...
    <div className="content home">
        ...
        <div className="col-sm-12 px-0">
          <div className="pending-loan">
            <div className="d-flex flex-row">
              <h5 className="me-3">Merchant Management - <span style={{color: "#9CA3AF", fontSize: "10px"}}>Manage merchants</span></h5>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-5 row mx-5">
        <div className="col-sm-12 px-0">
          <div className="pending-loan">
            <div className="d-flex flex-row">
              <h5 className="me-3">All Your Merchants </h5>
            </div>
                ...
                <td>
                  <div className="dropdown">
                    ...
                    <ul class="dropdown-menu details">
                      <li>
                        <a className="dropdown-item" href="/manage-merchant/details">
                          View Details
                        </a>
                      </li>
                    </ul>
        ...
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title">Add Merchant</h1>
