                                ...
                                <div className="row">
                                  ...
                                  <div className="col-sm-6 text-end">
                                    <form className="modal-m">
                                      <textarea type="text" className="form-control" defaultValue="Name dies not tally with name on the NIMC" />
                                    </form>
                                  </div>
                                </div>
                            ...
                            <div className="details-card pb-0">
                              <div className="bg-white p-4">
                                <div className="row justify-content-between">
                                  ...
                                  <div className="col-sm-6 mt-4">
                                    <form className="modal-m">
                                      <textarea type="text" className="form-control" defaultValue="User’s address cannot be verified from the document ptovided" />
                                    </form>
                                  </div>
                                </div>
